...
export default function possible_squares(Squares,y,x){
    ...
    console.log('TEST POSSIBLE SQUARES : 1   ',y,x)
    ...
    for (let i = 0; i < initial_possible_moves.length; i++) {
        ...
        copy[y][x].position = [y_test,x_test];//change the position in the object
        copy[y][x].move_number --;//increment the move number
        copy[y_test][x_test] = 0; //assign 0 to the vacated square
    }
